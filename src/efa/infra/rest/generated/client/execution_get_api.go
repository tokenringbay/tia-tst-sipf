...
type ExecutionGetApiService service


/* ExecutionGetApiService getExecutionDetail
 Get the detailed output of the given execution ID
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param id Detailed output of the given execution ID
 @return DetailedExecutionResponse*/
func (a *ExecutionGetApiService) ExecutionGet(ctx context.Context, id string) (DetailedExecutionResponse,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  DetailedExecutionResponse
	)
