...
type SupportSaveApiService service


/* SupportSaveApiService getSupport
 Capture the supportsave data and return the file name in the response
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @return SupportsaveResponse*/
func (a *SupportSaveApiService) SupportSave(ctx context.Context) (SupportsaveResponse,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  SupportsaveResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/support"
